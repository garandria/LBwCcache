...
{ time singularity run --bind /srv/local/grandria:/srv/local/grandria build-env.sif python3 LBwCcache/main.py --linux-src /srv/local/grandria/linux-5.13 --configurations /srv/local/grandria/LBwCcache/b1 >> out.log ; } 2>>out.log
